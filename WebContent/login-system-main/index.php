...
<body>
	...
	<div class="container">
<a href="https://asifalijaun.github.io/asifpersonal" target="_blank"><img src="" alt="" width="350px" ></a><br><hr>
...
?>
  ...
  <i class="fa fa-plus"></i> Add New People
  </button>
  <hr>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">Department type</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="construction.png" width="300px" height="180px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter Customer Id." maxlength="12" required>
</div>
<div class="form-group col-md-6">
...
<div class="form-group">
<label for="inputAddress">Construction Type</label>
<input type="text" class="form-control" name="staff_id" maxlength="12" placeholder="Enter Construction Type">
</div>
